...
namespace EfCoreTopics.Migrations
{
    ...
    [Migration("20220708095341_SpecialProductWithDetails-1")]
    partial class SpecialProductWithDetails1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("SpecialProductSequence")
                .StartsAt(10L)
                .IncrementsBy(5);
            ...
            modelBuilder.Entity("EfCoreTopics.Database.Models.Address", b =>
                {
                    ...
                    b.Property<string>("SearchTerm")
                        ...
                        .HasComputedColumnSql("[City] + ',' + [PostalCode]");
            ...
            modelBuilder.Entity("EfCoreTopics.Database.Models.Functions.Category", b =>
                {
            ...
            modelBuilder.Entity("EfCoreTopics.Database.Models.Functions.CustomerInformation", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EfCoreTopics.Database.Models.NonKeyModels.CityWithProvince", b =>
                {
                    b.Property<string>("City")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("EfCoreTopics.Database.Models.ProductPrice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProductPrice", "SalesLT");
                });

            modelBuilder.Entity("EfCoreTopics.Database.Models.ProductPriceHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EfCoreTopics.Database.Models.SpecialProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseHiLo(b.Property<int>("Id"), "SpecialProductSequence");
            ...
            modelBuilder.Entity("EfCoreTopics.Database.Models.SpecialProductPrice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EfCoreTopics.Database.Models.VProductModelCatalogDescription", b =>
                {
                    ...
                    b.HasComment("Displays the content from each element in the xml column CatalogDescription for each product in the Sales.ProductModel table that has catalog data.");
                });
            ...
            modelBuilder.Entity("EfCoreTopics.Database.Models.ProductPrice", b =>
                {
                    b.OwnsOne("EfCoreTopics.Database.ValueObjects.Money", "Money", b1 =>
                        {
                            ...
                            b1.ToTable("ProductPrice", "SalesLT");
            ...
            modelBuilder.Entity("EfCoreTopics.Database.Models.SpecialProductPrice", b =>
                {
                    b.HasOne("EfCoreTopics.Database.Models.SpecialProduct", "SpecialProduct")
                        .WithMany("SpecialProductPrices")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("EfCoreTopics.Database.Models.SpecialProduct", b =>
                {
                    b.Navigation("SpecialProductPrices");
                });
